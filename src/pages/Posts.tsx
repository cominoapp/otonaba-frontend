...
const Posts: React.FC = () => {
  ...
  return (
    ...
    <> 
      <SEO 
        title="掲示板 - オトナバ | 大人の交流コミュニティ"
        description="30代以上の大人が集まる掲示板。一般、趣味、健康、旅行、グルメ、日常、雑談、悩み、自己紹介、友達募集、ペット、お金、地元交流、人生相談、愚痴など様々なカテゴリーで交流できます。"
        keywords="掲示板,大人,交流,30代,40代,50代,コミュニティ,趣味,健康,旅行,グルメ,人生相談"
        url="https://otonaba.vercel.app/posts"
      />
